...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/02/24 16:36:25 by ttridon           #+#    #+#             */
/*   Updated: 2017/02/24 18:33:57 by ttridon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sub(unsigned char *arena, t_process *process)
{
	...
	tmp_PC = process->PC;
	process->carry = 0;
	//if (arena[process->PC] >> 6 == REG_CODE && (arena[process->PC] >> 4 & 0x03) == REG_CODE && (arena[process->PC] >> 2 & 0x03) == REG_CODE)
	//{
